...
makedepends=('acl' 'cryptsetup' 'docbook-xsl' 'gperf' 'lz4' 'xz' 'pam' 'libelf'
             ...
             'bash-completion')
options=('strip')
source=('git+https://github.com/systemd/systemd#tag=v242'
        '0001-Use-Arch-Linux-device-access-groups.patch'
		'0002-Enable-Hibernate-And-Reboot.patch'
        'initcpio-hook-udev'
...
sha512sums=('SKIP'
            ...
            '5e75297927dd9fa520600e1ae6e44288edb9ce23fc4b50155c344a40216b743246c864d3f715f6d852c3705414c0ceda5dd5a74f59d85bdf0e7ef6adb1e6ed1c'
...
prepare() {
  ...
  # Enable Hibernate and reboot
  patch -Np1 -i ../0002-Enable-Hibernate-And-Reboot.patch
}
